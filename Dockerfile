...
RUN curl -S -L "http://eformat.co.nz/apiman/apiman-distro-wildfly8-1.1.7.Final-overlay.zip" -o apiman-distro-wildfly8-1.1.7.Final-overlay.zip
...
RUN echo "apiman-gateway.public-endpoint=https://api.cloudapps.ose.eformat.co.nz:8443/api-gateway/" >> /usr/local/apiman/wildfly-8.2.0.Final/standalone/configuration/apiman.properties
